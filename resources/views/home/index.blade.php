            ...
            <div class="row">
              <div class="col-8 text-nowrap text-truncate text-capitalize">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <span class="px-2">
                    {{isset($post->views) && $post->views ? $post->views : 0}}
                  </span>
                </div>
              </div>
              <div class="col-4">
                <div class="row">
                  ...
                  <div class="col-4">
                    <div class="d-inline-flex">
                      ...
                      @endif
                      <button class="ml-2 deletePostButton btn btn-danger" {{(isset($user_auth->isAdmin) && $user_auth->isAdmin==true) || (isset($user_auth)) && (isset($post->user_id) && $post->user_id == $user_auth->id) ? "":"disabled"}}
