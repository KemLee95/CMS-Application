            ...
            <div class="col-12 text-nowrap text-truncate text-capitalize">
              <div class="d-flex align-items-center justify-content-between">
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                  ...
                  >
                    <input type="radio" value="published" name="status" class="status" autocomplete="off" {{isset($post->status) && $post->status === 'published' ? "checked":""}}>
                    <span>
                  ...
                  >
                    <input type="radio" value="unpublished" name="status" class="status" autocomplete="off" {{isset($post->status) && $post->status === 'unpublished' ? "checked":""}}>
                    <span>
